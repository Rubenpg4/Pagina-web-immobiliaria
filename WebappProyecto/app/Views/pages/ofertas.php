<head>
    <link rel="stylesheet" href="<?= base_url("css/ofertas.css") ?>">
...
<div class="container-ofertas-titulo">
    <section class="section-ofertas-titulo">
        <div class="ofertas-titulo ">
            <h3 class="titulo-inicial animate-from-bottom">Ofertas inmobiliarias destacadas</h3>
            <p class="text-titulo animate-from-bottom-2">Descubre nuestras promociones en propiedades exclusivas para ti</p>
        </div>
    </section>
</div>
...
?>
    ...
    <?php if (sizeof($viviendas) > 0) { ?>
        <?php foreach ($viviendas as $rowVivienda) { ?>
            <?php if ($rowVivienda->disponible == 1 && $rowVivienda->ofertas == 1) { ?>
